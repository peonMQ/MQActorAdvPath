...
// uint32 zoneid = 3;
inline void Position::clear_zoneid() {
  _impl_.zoneid_ = 0u;
}
inline uint32_t Position::_internal_zoneid() const {
  return _impl_.zoneid_;
}
inline uint32_t Position::zoneid() const {
  // @@protoc_insertion_point(field_get:mq.proto.actorfollowee.Position.zoneid)
  return _internal_zoneid();
}
inline void Position::_internal_set_zoneid(uint32_t value) {
  
  _impl_.zoneid_ = value;
}
inline void Position::set_zoneid(uint32_t value) {
  _internal_set_zoneid(value);
  // @@protoc_insertion_point(field_set:mq.proto.actorfollowee.Position.zoneid)
}
